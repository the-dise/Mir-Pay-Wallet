...
fun ScalingLazyListScope.vibrateEverySecondChip(
    onToggleVibrateEverySecond: Boolean, onToggleVibrateEverySecondAction: (Boolean) -> Unit

) = item {
    var checked by remember { mutableStateOf(onToggleVibrateEverySecond) }
    ...
    ToggleChip(
        ...
        onCheckedChange = { newChecked ->
            checked = newChecked
            onToggleVibrateEverySecondAction(newChecked)
        },
        appIcon = {
            Icon(
